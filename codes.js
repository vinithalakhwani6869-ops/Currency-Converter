...
//creating dropdowns
for (let currrency in countryList) {
   let option1 = document.createElement("option");
   option1.value = currrency;
   option1.innerText = currrency;
   fromCurrency.append(option1);

   let option2 = document.createElement("option");
   option2.value = currrency;
   option2.innerText = currrency;
   toCurrency.append(option2);
}
// default values
fromCurrency.value = "USD";
toCurrency.value = "INR";
// updating flags with user-choice
fromCurrency.addEventListener("change",()=>{
  const code = countryList[fromCurrency.value];
  fromFlag.src = `https://flagsapi.com/${code}/flat/64.png`;
});

toCurrency.addEventListener("change",()=>{
  const code = countryList[toCurrency.value];
